...
<body>
  ...
  <div class="container mb-5">
    ...
    <form class method="POST" action="{{route('addhotwater')}}">
      @csrf
      @method('POST')
      ...
      <input type="submit" class="btn btn-primary mb-5" value="success" />


    </form>
  </div>
  <footer class="u-align-center u-clearfix u-footer u-grey-80   " id="sec-d6ff" style="bottom:0; position:relative; width:100%;">
    <div class="u-clearfix u-sheet u-sheet-1">
      <div class="row mt-5">
        <div class="col">
